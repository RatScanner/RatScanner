...
public partial class Item {
	...
	public string? GetBestTraderImageLink() {
		TraderPrice? price = GetBestTraderOffer();
		if (price == null) return null;
		return $"https://assets.tarkov.dev/{price.Trader}.webp";
	}

	public string? GetBestTraderName() {
		// JSON API does not embed trader nicknames in item prices; return null so callers can handle fallback.
		return null;
	}
}

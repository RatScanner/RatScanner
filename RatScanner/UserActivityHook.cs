...
namespace RatScanner
{
	...
	/// </summary>
	/// <remarks>
	/// From: https://www.codeproject.com/Articles/7294/Processing-Global-Mouse-and-Keyboard-Hooks-in-C
	/// </remarks>
	internal class UserActivityHook
	{
		...
		/// </remarks>
		internal UserActivityHook(bool InstallMouseHook, bool installKeyboardHook)
		{
		...
		/// </summary>
		internal event MouseEventHandler OnMouseActivity;
		/// <summary>
		...
		/// <param name="installKeyboardHook"><b>true</b> if keyboard events must be monitored</param>
		/// <exception cref="Win32Exception">Any windows problem.</exception>
		internal void Start(bool InstallMouseHook, bool installKeyboardHook)
		{
		...
		/// <exception cref="Win32Exception">Any windows problem.</exception>
		internal void Stop(bool UninstallMouseHook, bool uninstallKeyboardHook, bool throwExceptions)
		{
